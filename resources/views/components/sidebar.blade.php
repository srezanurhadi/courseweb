    ...
    <aside class="bg-gradient-to-b from-sky-600 to-indigo-900 w-54 flex flex-col space-y-1">
        ...
        @if (Request::is('admin*'))
            ...
            <a href="{{ url('/admin/mycontent') }}"
                class="{{ Request::is('admin/mycontent*') ? 'border-white bg-white/20 shadow-lg' : 'border-white/30' }} ml-6 p-2 mr-2 rounded-lg border-l-8  hover:border-white hover:bg-white/20 hover:shadow-lg transition-all duration-200">
            ...
            <a href="{{ url('/admin/mycourse') }}"
                class="{{ Request::is('admin/mycourse*') ? 'border-white bg-white/20 shadow-lg' : 'border-white/30' }} ml-6 p-2 mr-2 rounded-lg border-l-8  hover:border-white hover:bg-white/20 hover:shadow-lg transition-all duration-200">
            ...
            <a href="{{ url('/admin/myparticipant') }}"
                class="{{ Request::is('admin/myparticipant*') ? 'border-white bg-white/20 shadow-lg' : 'border-white/30' }} ml-6 p-2 mr-2 rounded-lg border-l-8  hover:border-white hover:bg-white/20 hover:shadow-lg transition-all duration-200">
        ...
        @if (Request::is('user*'))
            ...
            <a href="{{ url('/user/course') }}"
                class=" {{ Request::is('user/course*') && !Request::is('user/mycourse*') && request('from') != 'my-course' ? 'border-white bg-white/20 shadow-lg' : 'border-white/30' }} ml-6 mr-2 p-2 rounded-lg border-l-8 hover:border-white hover:bg-white/20 hover:shadow-lg transition-all duration-200">
                <i class="fas fa-book-open-reader  text-white pl-1"></i>
                <span class="text-white pl-1 font-semibold text-20">Courses</span></a>
            <a href="{{ url('/user/mycourse') }}"
                class="{{ Request::is('user/mycourse*') || (Request::is('user/course*') && request('from') == 'my-course') ? 'border-white bg-white/20 shadow-lg' : 'border-white/30' }} ml-6 mr-2 p-2 rounded-lg border-l-8 hover:border-white hover:bg-white/20 hover:shadow-lg transition-all duration-200">
                <i class="fas fa-book text-white pl-1"></i>
                <span class="text-white pl-1 font-semibold text-20">My Course</span></a>
            <a href="{{ url('/user/history') }}"
                class="{{ Request::is('user/history*') ? 'border-white bg-white/20 shadow-lg' : 'border-white/30' }} ml-6 mr-2 p-2 rounded-lg border-l-8 hover:border-white hover:bg-white/20 hover:shadow-lg transition-all duration-200">
            ...
            <a href="{{ url('/user/profile') }}"
                class="{{ Request::is('user/profile*') ? 'border-white bg-white/20 shadow-lg' : 'border-white/30' }} ml-6 mr-2 p-2 rounded-lg border-l-8 hover:border-white hover:bg-white/20 hover:shadow-lg transition-all duration-200">
                <i class="fas fa-user text-white pl-1"></i>
                <span class="text-white pl-1 font-semibold text-20">My Profile</span></a>
        @endif
