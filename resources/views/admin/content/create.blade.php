...
<body>
    <div class="flex flex-1 ">
        ...
        <div class="w-full bg-gray-50 flex flex-col p-4 overflow-hidden">
            <form action="/admin/content" method="POST" id="contentForm">
                @csrf
                <div class="bg-gray-100 h-full p-4 pl-6 rounded-lg shadow-[0px_0px_2px_1px_rgba(0,0,0,0.4)] flex flex-col gap-2">
