                            ...
                            <div class="flex gap-2">
                                ...
                                <div class="flex gap-1 items-center rounded-lg border-gray-400 border-2 px-2">
                                    ...
                                    <select name="category" id="category"
                                        ...
                                        <option value="admin" {{ request('category') == 'admin' ? 'selected' : '' }}>
                                            Admin
                                        </option>
                                    ...
                                    <tr class="bg-white border-t hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex space-x-2">
                                                <button id="openModalBtn-{{ $user->id }}"
                                                ...
                                                <form action="users/{{ $user->name }}" method="post">
                                                    @method('delete')
                                                    @csrf
                                                    {{-- Tombol ini sekarang memicu modal, bukan confirm() --}}
                                                    <button type="button" class="delete-btn"
                                                        data-title="{{ $user->name }}">
                                                        <div
                                                            class="bg-red-500 p-1 rounded-sm w-8 h-8 flex items-center justify-center group hover:bg-white hover:border-2 hover:border-red-500 transition-full duration-200">
                                                            <span
                ...
                @foreach ($users as $user)
                    <div class="">
                        <div id="modal-{{ $user->id }}"
                            class="modal hidden opacity-0 fixed inset-0 bg-black/50 backdrop-blur-xs transition-all duration-500 ease-in-out flex items-center justify-center z-50 pl-75 p-25">

                            {{-- Konten Modal --}}
                            <div
                                class="min-w-full bg-slate-100 rounded-lg pl-15 p-3  max-h-[90vh] flex flex-col gap-4 overflow-y-auto">
                                <div class="flex justify-end relative">
                                    {{-- Tombol tutup sekarang menggunakan ID unik untuk JS --}}
                                    <button id="closeModalBtn-{{ $user->id }}"
                                        data-modal-id="{{ $user->id }}"
                                ...
                                <div class="flex gap-2">
                                    <div class=" w-2/3">
                                        <div class="mb-2">
                                            <div for="full-name" class="block text-gray-700 text-sm font-bold mb-2">
                                                Full
                                                Name</div>
                                            <div
                                            ...
                                            @else
                                                <svg class="w-20 h-20 text-gray-500" fill="currentColor"
                                                    ...
                                                    <path fill-rule="evenodd"
                                                        d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z"
                                                        clip-rule="evenodd"></path>
>>>>>>> e7201a13e5db7afb09bb7a3a3df9bf0072bf2edf
                                                </svg>
                                            </button>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="space-y-2">
                                            <li
                                                ...
                                                <div class="flex items-center max-w-200 overflow-hidden">
                                                    <div class="size-4 rounded-md bg-yellow-300 mr-2 flex-shrink-0">
                                                    </div>
                                                    <span class="truncate min-w-0">Tutorial Laravel 12 2024 mantap
                                                        Lorem
                                                        ipsum
                                                        dolor sit amet consectetur adipisicing elit. Accusantium, modi?
                                                        Ea
                                                        est
                                                        facere ad natus! Quos eaque nulla voluptatum aliquid, iste fugit
                                                        quis
                                                        est expedita incidunt possimus in, velit perspiciatis
                                                        accusantium
                                                        laudantium. Labore esse, laborum corrupti architecto
                                                        consequuntur,
...
>>>>>>> e7201a13e5db7afb09bb7a3a3df9bf0072bf2edf
                ...
                {{-- AWAL DARI MODAL KONFIRMASI HAPUS --}}
                <div id="delete-confirmation-modal"
                    class="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm transition-all duration-300 ease-in-out opacity-0 scale-95 pointer-events-none">
                ...
                {{-- AKHIR DARI MODAL KONFIRMASI HAPUS --}}
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Menggunakan class untuk menemukan semua tombol hapus
            ...
            const hideModal = () => {
                ...
                }, 300); // Durasi harus cocok dengan transisi CSS
            };

            // Tambahkan listener ke setiap tombol hapus
            ...
            // Listener untuk menutup modal dengan klik di background
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Ambil tombol BUKA berdasarkan awalan ID-nya
            const openModalButtons = document.querySelectorAll('[id^="openModalBtn-"]');

            // Ambil tombol TUTUP berdasarkan awalan ID-nya
            ...
            // Event listener untuk menutup modal dengan klik di background
