...
<head>
    ...
    <script src="https://unpkg.com/heroicons@2.0.20/dist/outline.esm.js"></script>
</head>
...
<body class="bg-gray-100 p-4">
    <div class="p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
        <div class="flex justify-between items-center mb-4">
            ...
            <button class="bg-indigo-600 text-white text-sm px-4 py-2 rounded hover:bg-indigo-700">
                + Add Course
            </button>
        </div>
            ...
            <div class="flex items-start p-4 border border-gray-300 rounded-md bg-white shadow-sm">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-600">
                        UI adalah salah satu cara untuk mendesign sesuai tampilan halaman UI adalah salah satu cara
