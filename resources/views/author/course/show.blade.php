        ...
        <div class="flex flex-1">
            ...
            <div class="w-full bg-gray-50 flex flex-col">
                    ...
                    <div class="flex flex-row">
                        <div class="w-1/3 flex flex-col px-8 pt-8 ">
                            <div class="w-68 flex flex-col items-center">
                                ...
                                <div class="flex items-center p-2 gap-2 mt-2">
                                    <div class="font-semibold text-gray-800">Course By:</div>
                                    <div
                                        class="rounded-full h-6 w-6 p-1 text-gray-50 bg-amber-500 flex items-center justify-center">
                                        J
                                    </div>
                                    <div class="text-gray-800 text-sm">Wijokododo</div>
                                </div>
                            </div>
                        </div>
                        <div class="w-2/3 flex flex-col py-8 pr-8 ">
                            <div class=" px-3 text-xs bg-rose-600 rounded-2xl self-end text-gray-50">Draft</div>
                            <div class="flex gap-8">
                                <div class="p-1 text-xs bg-indigo-200 rounded-2xl text-indigo-700">Web Developmment
                                </div>
                            ...
                            <div class="pt-2 text-4xl font-bold">Belajar Dasar-dasar HTML & CSS</div>
                            <div class="pt-2 text-md/5 line-clamp-6">Lorem ipsum dolor sit amet, consectetur adipiscing
                ...
                <div class="flex justify-around w-full p-8 gap-8">
                    <div class="w-1/3 h-58 overflow-y-auto px-2 pb-2 rounded-lg shadow-[0px_0px_4px_1px_rgba(0,0,0,0.4)] bg-indigo-50">
                    ...
                    <div class="w-2/3 flex flex-col justify-between">
                        <div class="p-4 rounded-lg shadow-[0px_0px_4px_1px_rgba(0,0,0,0.4)] bg-indigo-50">
                            ...
                            <div class="text-md/5 line-clamp-5 text-ellipsis">Lorem ipsum dolor sit amet, consectetur
                        ...
                        <Div class="flex justify-between">
                            <div class="py-1 px-2 w-22 text-center rounded-lg bg-indigo-700 text-white">previous</div>
