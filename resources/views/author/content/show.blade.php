    ...
    <div class="flex flex-1">
        ...
        <div class=" w-full bg-gray-50 border ">
            ...
            <div class="w-full flex pt-8 px-4 justify-between">
                <div class="w-full flex flex-wrap gap-2 text-2xl font-bold">
                    <div class="w-full flex gap-2 items-center p-2">
                        ...
                        <div class=" py-1 px-3 border-amber-500 text-amber-500 bg-amber-100 rounded-sm border-2">
                            <i class="fas fa-pencil-alt"></i> <span class="pl-2">Edit</span>
                        </div>
                        <div class=" py-1 px-3 border-rose-500 text-rose-500 bg-rose-100 rounded-sm border-2">
