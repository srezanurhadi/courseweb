...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="bg-custom-gradient shadow-xl relative overflow-hidden">
        ...
        <div class="absolute top-20 right-1/3 w-14 h-14 bg-white/8 rounded-full floating-element" style="animation-delay: -3s;"></div>
        <div class="absolute bottom-32 right-10 w-18 h-18 bg-white/6 rounded-full floating-element" style="animation-delay: -1s;"></div>
        
        <div class="relative max-w-6xl mx-auto px-6 py-12">
            <div class="text-center">
                <div class="inline-flex items-center justify-center w-20 h-20 icon-gradient rounded-full mb-6 shadow-lg">
            ...
            <div class="space-y-10">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="grid md:grid-cols-3 gap-6">
                                <div class="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
                                    ...
                                    <p class="text-sm text-gray-600">Nama, alamat email, dan nomor telepon yang Anda berikan saat mendaftar atau berpartisipasi dalam aktivitas platform.</p>
                                </div>
                                <div class="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-xl border border-green-100">
                                    ...
                                    <p class="text-sm text-gray-600">Alamat IP, jenis browser, waktu akses, dan halaman yang Anda lihat dikumpulkan secara otomatis oleh server kami.</p>
                                </div>
                                <div class="bg-gradient-to-br from-purple-50 to-violet-50 p-6 rounded-xl border border-purple-100">
                                    ...
                                    <p class="text-sm text-gray-600">Kemajuan kursus, kuis yang diselesaikan, dan sertifikat yang diperoleh untuk melacak perkembangan belajar Anda.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="group">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <h2 class="text-2xl font-bold text-gray-900 mb-4 group-hover:text-green-600 transition-colors">
                                2. Bagaimana Kami Menggunakan Informasi Anda
                            </h2>
                            <p class="text-gray-700 mb-6 leading-relaxed">
                                Memiliki informasi yang akurat tentang Anda memungkinkan kami untuk memberikan pengalaman yang lancar dan efisien. 
                ...
                <div class="group">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <h2 class="text-2xl font-bold text-gray-900 mb-4 group-hover:text-orange-600 transition-colors">
                            ...
                            <div class="bg-red-50 border border-red-200 rounded-xl p-6 mb-4">
                                ...
                                <p class="text-red-700">
                                    Kami tidak akan membagikan, menjual, menyewakan, atau memperdagangkan informasi pribadi Anda dengan pihak ketiga untuk tujuan promosi mereka.
                                </p>
                            </div>
                            <p class="text-gray-700 leading-relaxed">
                                Kami dapat membagikan informasi Anda dengan pihak ketiga yang melakukan layanan untuk kami atau atas nama kami, 
                                termasuk pemrosesan pembayaran dan analisis data. Kami juga dapat mengungkapkan informasi Anda jika diwajibkan oleh hukum.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-700 leading-relaxed">
                                ...
                                Meskipun kami telah mengambil langkah-langkah yang wajar untuk mengamankan informasi pribadi yang Anda berikan kepada kami, 
                ...
                <div class="group">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <h2 class="text-2xl font-bold text-gray-900 mb-4 group-hover:text-purple-600 transition-colors">
                                5. Hak Anda
                            </h2>
                            <p class="text-gray-700 leading-relaxed">
                ...
                <div class="group">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <h2 class="text-2xl font-bold text-gray-900 mb-4 group-hover:text-indigo-600 transition-colors">
                                6. Perubahan pada Kebijakan Ini
                            </h2>
                            <p class="text-gray-700 leading-relaxed">
                                Kami dapat memperbarui Kebijakan Privasi ini dari waktu ke waktu. Versi yang diperbarui akan ditandai dengan tanggal 
                                "Terakhir diperbarui" yang diperbarui dan akan berlaku segera setelah dapat diakses. Kami menganjurkan Anda untuk 
                                meninjau kebijakan privasi ini secara berkala agar tetap mengetahui bagaimana kami melindungi informasi Anda.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="group">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <h2 class="text-2xl font-bold text-gray-900 mb-4 group-hover:text-teal-600 transition-colors">
                                7. Hubungi Kami
                            </h2>
                            <p class="text-gray-700 mb-4 leading-relaxed">
                            ...
                            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:support@rdosen.com" class="text-blue-600 hover:text-blue-800 font-medium transition-colors">
                                            support@rdosen.com
                                        </a>
                                    </div>
                                </div>
