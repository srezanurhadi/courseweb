    ...
    <div class="relative min-h-screen w-full flex">
        ...
        <div class="relative z-10 w-full flex-grow flex items-center justify-center p-4">
            <div class="w-full max-w-3xl lg:max-w-4xl flex flex-col md:flex-row shadow-2xl rounded-[40px] overflow-hidden">
                ...
                <div class="w-full md:w-[50%] bg-white p-8 sm:p-10 lg:p-12 flex flex-col justify-center order-2 md:order-1">
                    <div class="w-full max-w-xs sm:max-w-sm mx-auto">
                        ...
                        <form action="#" method="POST">
                            ...
                            <div class="flex items-center justify-between mb-6 text-xs sm:text-sm">
                                <div class="flex items-center">
                                    ...
                                    <label for="remember-me" class="ml-2 block font-medium text-gray-400">Remember me</label>
                                </div>
                                <div>
                                    <a href="#" class="font-medium text-blue-900 hover:text-blue-600">Forgot the password?</a>
                                </div>
                            </div>
                        ...
                        <p class="mt-8 text-center text-xs sm:text-sm text-gray-600">
                            Don't have an account yet? <a href="#" class="font-medium text-blue-900 hover:text-blue-600">Register</a>
                        </p>
                    </div>
                </div>

                <div class="w-full md:w-[50%] bg-custom-gradient p-8 sm:p-8 lg:p-8 flex flex-col justify-center items-center text-white order-1 md:order-2 relative overflow-hidden">
                    ...
                    <div class="w-full max-w-xs sm:max-w-sm text-right relative z-10 ml-auto mr-4">
                        <h2 class="text-2xl sm:text-3xl font-bold mb-2">Hallo,<br>Selamat Datang Kembali<br>di Ruang Dosen !</h2>
                    ...
                    <div class="relative w-full max-w-sm h-64 mt-4">
                        <svg viewBox="0 0 300 250" class="w-full h-full">
                            <!-- Background circles -->
                            <circle cx="220" cy="180" r="40" fill="#10B981" opacity="0.8" class="illustration-float"/>
                            ...
                            <g class="illustration-float" style="animation-delay: -1s;">
                                <!-- Star -->
                                <path d="M 50 100 L 52 106 L 58 106 L 53 110 L 55 116 L 50 112 L 45 116 L 47 110 L 42 106 L 48 106 Z" fill="#FBBF24"/>
                            ...
                            <text x="200" y="50" font-family="Arial" font-size="20" fill="white" opacity="0.6" class="illustration-float" style="animation-delay: -2s;">∑</text>
                            <text x="40" y="180" font-family="Arial" font-size="16" fill="white" opacity="0.5" class="illustration-float" style="animation-delay: -0.5s;">π</text>
                            <text x="250" y="140" font-family="Arial" font-size="18" fill="white" opacity="0.4" class="illustration-float" style="animation-delay: -1.5s;">∞</text>
                        </svg>
                    </div>
                </div>
            </div>
