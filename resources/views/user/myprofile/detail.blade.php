                ...
                <div class="px-6 py-0.5">
                    <div class="flex items-center justify-between h-16">
                        <div class="flex items-center px-4">
                            <h1 class="text-3xl font-bold text-gray-800">My Profile / Detail Introducing to Figma</h1>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 mb-4">
                                ...
                                <div class="flex justify-center">
                                    <img src="{{ asset('images/certificate-placeholder.jpg') }}" alt="Certificate Preview" class="max-w-full h-auto shadow-md">
                                </div>
                            </div>
                        </div>
                        
                        <button class="bg-indigo-700 text-white rounded-md px-6 py-2 text-lg font-semibold hover:bg-indigo-800 transition-colors">
