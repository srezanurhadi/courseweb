    ...
    <div class="relative min-h-screen w-full flex">
        ...
        <div class="relative z-10 w-full flex-grow flex items-center justify-center p-4">
            <div
                ...
                <div
                    class="w-full md:w-[50%] bg-custom-gradient p-8 sm:p-8 lg:p-8 flex flex-col justify-center items-center text-white order-1 md:order-1 relative overflow-hidden">
                    ...
                    <div class="relative w-full max-w-sm h-64 mt-4">
                        <svg viewBox="0 0 300 250" class="w-full h-full">
                            <circle cx="80" cy="180" r="40" fill="#10B981" opacity="0.8"
                            ...
                            <g class="illustration-float" style="animation-delay: -1s;">
                                <path
                                    d="M 250 100 L 252 106 L 258 106 L 253 110 L 255 116 L 250 112 L 245 116 L 247 110 L 242 106 L 248 106 Z"
                                    fill="#FBBF24" />
                            ...
                            <text x="100" y="50" font-family="Arial" font-size="20" fill="white" opacity="0.6"
                                class="illustration-float" style="animation-delay: -2s;">∑</text>
                            <text x="260" y="180" font-family="Arial" font-size="16" fill="white" opacity="0.5"
                                class="illustration-float" style="animation-delay: -0.5s;">π</text>
                            <text x="50" y="140" font-family="Arial" font-size="18" fill="white" opacity="0.4"
                ...
                <div
                    class="w-full md:w-[50%] bg-white p-8 sm:p-10 lg:p-12 flex flex-col justify-center order-2 md:order-2">
                    <div class="w-full max-w-xs sm:max-w-sm mx-auto">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="relative">
                                    ...
                                    <span id="toggleConfirmPassword"
                                        class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer text-gray-400 hover:text-gray-600">
                                        <svg id="confirm_eye_icon_open" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <svg id="confirm_eye_icon_closed" xmlns="http://www.w3.org/2000/svg"
                                            fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        ...
                        <p class="mt-8 text-center text-xs sm:text-sm text-gray-600">
                            Sudah punya akun? <a href="/login"
                                class="font-medium text-blue-900 hover:text-blue-600">Login</a>
                        </p>
                    </div>
                </div>
            </div>
