...
<head>
    ...
    <style>
        ...
        body {
            ...
            /* DIUBAH: Latar belakang diberi pola halus untuk kedalaman */
        ...
        .certificate-container {
            ...
            position: relative;
            color: #ffffff;
            /* DIUBAH: Border lebih elegan menggunakan 'double' */
            border: 10px double #e0d03b;
            border-radius: 15px;
            /* BARU: Bayangan halus di dalam untuk efek premium */
            box-shadow: 0 0 0 3px #290d6e, 0 0 20px rgba(0, 0, 0, 0.5);
        }

        /* BARU: CSS untuk ornamen sudut */
        .corner-ornament {
            position: absolute;
            width: 80px;
            height: 80px;
        ...
        .subtitle {
            font-size: 1.1rem;
            color: #ffffff;
            /* DIUBAH: Dibuat putih agar lebih kontras */
            margin-bottom: 1rem;
        }
        ...
        .certificate-footer {
            ...
            /* DIUBAH: Menggunakan Flexbox untuk tata letak yang lebih baik */
            display: flex;
