        ...
        <div class="content-card rounded-3xl p-8 md:p-12 mb-12">
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <p class="text-gray-700 leading-relaxed">
                                Dengan mendaftar dan menggunakan platform R. Dosen, Anda menyetujui untuk terikat dengan
            ...
            <div class="mb-12">
                ...
                <div class="section-item p-6 rounded-2xl border border-gray-100">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <p class="text-gray-700 leading-relaxed">
                                R. Dosen adalah platform pembelajaran online yang menyediakan akses ke berbagai materi
                                pembelajaran,
            ...
            <div class="mb-12">
                ...
                <div class="section-item p-6 rounded-2xl border border-gray-100">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <p class="text-gray-700 leading-relaxed mb-4">Sebagai pengguna platform R. Dosen, Anda
            ...
            <div class="mb-12">
                ...
                <div class="section-item p-6 rounded-2xl border border-gray-100">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <p class="text-gray-700 leading-relaxed">
                                Semua konten yang tersedia di platform R. Dosen, termasuk teks, gambar, video, dan
            ...
            <div class="mb-12">
                <div class="section-header p-6 rounded-2xl mb-8">
                    <div class="flex items-center">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl flex items-center justify-center mr-4">
                ...
                <div class="section-item p-6 rounded-2xl border border-gray-100">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <p class="text-gray-700 leading-relaxed">
                                Kami menghormati privasi Anda dan berkomitmen untuk melindungi data pribadi Anda sesuai
                                dengan
            ...
            <div class="mb-12">
                ...
                <div class="section-item p-6 rounded-2xl border border-gray-100">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <p class="text-gray-700 leading-relaxed">
                                R. Dosen tidak bertanggung jawab atas kerugian langsung, tidak langsung, insidental,
                                atau konsekuensial
            ...
            <div class="mb-12">
                <div class="section-header p-6 rounded-2xl mb-8">
                    <div class="flex items-center">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-teal-500 to-teal-600 rounded-xl flex items-center justify-center mr-4">
