    ...
    <div class="max-w-6xl mx-auto px-6 -mt-12 relative z-10 pb-16">
        ...
        <div class="content-card rounded-3xl p-8 md:p-12 mb-12">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="space-y-6">
                        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-2xl border border-blue-100">
                            <p class="text-gray-700 leading-relaxed text-lg">
                                Di <span class="font-bold text-indigo-600">R. Dosen</span>, kami percaya bahwa
                                pendidikan berkualitas adalah hak setiap individu untuk meraih mimpinya. Misi kami
                                adalah menyediakan platform pembelajaran yang mudah diakses, relevan dengan kebutuhan
                                industri, dan diajarkan langsung oleh para ahli di bidangnya.
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-gray-700 leading-relaxed text-lg">
                                Nama <span class="font-bold text-purple-600">"R. Dosen"</span> merepresentasikan "Ruang
                                Dosen", sebuah tempat di mana para pembelajar dapat terhubung dengan para ahli—para
                                'dosen' modern—untuk mendapatkan wawasan mendalam dan bimbingan yang nyata.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-center">
                    <div class="relative">
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-600 rounded-3xl transform rotate-6 opacity-20">
                        </div>
        ...
        <div class="content-card rounded-3xl p-8 md:p-12 mb-12">
            <div class="text-center mb-12">
                <div
                    class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="feature-card p-8 rounded-2xl shadow-lg border border-white/20">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 mx-auto">
                ...
                <div class="feature-card p-8 rounded-2xl shadow-lg border border-white/20">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center mb-6 mx-auto">
                ...
                <div class="feature-card p-8 rounded-2xl shadow-lg border border-white/20">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center mb-6 mx-auto">
        ...
        <div class="content-card rounded-3xl p-8 md:p-12 mb-12">
            <div class="text-center">
                <div
                    class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-pink-500 to-rose-600 rounded-full mb-8">
                ...
                <p class="text-xl text-gray-700 max-w-3xl mx-auto mb-8 leading-relaxed">
                    Apapun tujuanmu—meningkatkan karier, memulai bisnis, atau sekadar mempelajari hal baru—R. Dosen
                    hadir untuk mendukung setiap langkah perjalananmu.
                </p>
