                ...
                <div class="space-y-6">
                    <div class="faq-item p-6 rounded-2xl border border-gray-100">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 text-lg mb-3">Bagaimana cara membuat akun di R. Dosen?</h4>
                                <p class="text-gray-700 leading-relaxed">Anda dapat membuat akun dengan mengklik tombol <a href="/register" class="register-link">"Daftar"</a> atau <a href="/register" class="register-link">"Register"</a>, kemudian isi data yang diperlukan seperti nama, email, dan password, lalu ikuti petunjuk verifikasi email yang akan dikirimkan ke inbox Anda.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="faq-item p-6 rounded-2xl border border-gray-100">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 text-lg mb-3">Saya lupa kata sandi. Apa yang harus saya lakukan?</h4>
                                <p class="text-gray-700 leading-relaxed">Pada halaman login, klik link "Lupa Kata Sandi?". Masukkan alamat email yang terdaftar, dan kami akan mengirimkan tautan untuk mengatur ulang kata sandi Anda.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <div class="faq-item p-6 rounded-2xl border border-gray-100">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 text-lg mb-3">Bagaimana cara mendaftar (enroll) sebuah kursus?</h4>
                                <p class="text-gray-700 leading-relaxed">Kunjungi halaman detail kursus yang Anda inginkan, lalu klik tombol "Enroll Sekarang". Ikuti prosesnya hingga selesai, dan kursus akan otomatis muncul di halaman "My Course" Anda.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="faq-item p-6 rounded-2xl border border-gray-100">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 text-lg mb-3">Apakah saya mendapatkan akses selamanya ke kursus yang sudah dibeli?</h4>
                                <p class="text-gray-700 leading-relaxed">Ya! Sekali Anda terdaftar di sebuah kursus, Anda memiliki akses seumur hidup ke semua materi pembelajarannya, termasuk pembaruan di masa depan.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="faq-item p-6 rounded-2xl border border-gray-100">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 text-lg mb-3">Apakah saya akan mendapatkan sertifikat setelah menyelesaikan kursus?</h4>
                                <p class="text-gray-700 leading-relaxed">Tentu saja. Setelah menyelesaikan semua materi kursus, Anda akan mendapatkan sertifikat penyelesaian yang dapat diunduh dan dibagikan.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <div class="faq-item p-6 rounded-2xl border border-gray-100">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 text-lg mb-3">Metode pembayaran apa saja yang diterima?</h4>
                                <p class="text-gray-700 leading-relaxed">Saat ini kami menerima pembayaran melalui transfer bank dan e-wallet (GoPay, OVO, DANA). Kami terus berupaya untuk menambahkan metode pembayaran lainnya.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="faq-item p-6 rounded-2xl border border-gray-100">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 text-lg mb-3">Video pembelajaran tidak dapat diputar, apa solusinya?</h4>
                                <p class="text-gray-700 leading-relaxed">Pastikan koneksi internet Anda stabil. Coba segarkan (refresh) halaman. Jika masalah berlanjut, coba gunakan browser lain atau bersihkan cache browser Anda. Jika masih belum berhasil, hubungi tim support kami.</p>
                            </div>
                        </div>
                    </div>
                </div>
